...
void CCNodeLoaderLibrary::registerDefaultCCNodeLoaders() {
    ...
    this->registerCCNodeLoader("CCEditBox", CCEditBoxLoader::loader());
    //this->registerCCNodeLoader("CCLabelFX", CCLabelTTFLoader::loader());
    //this->registerCCNodeLoader("CCControlButtonWithFX", CCControlButtonLoader::loader());
    //this->registerCCNodeLoader("CCControlSwitch",CCControlSwitchLoader::loader() );
